...
export default function PortalSidebar() {
  ...
  const items = [
    ...
    { label: "Project", icon: FolderKanban, href: "/portal" },
    { label: "Invoices", icon: FileText, href: "/portal" },
    { label: "Payments", icon: CreditCard, href: "/portal" },
    { label: "Messages", icon: MessageCircle, href: "/portal" },
    { label: "Profile", icon: Settings, href: "/portal" },
  ];
    ...
    <aside className="w-full border-b border-white/10 bg-white/5 lg:min-h-screen lg:w-72 lg:border-b-0 lg:border-r">
      <div className="p-5">
        <div className="rounded-3xl border border-red-500/20 bg-red-500/10 p-5">
          ...
          <p className="mt-1 text-sm text-zinc-400">Dealer Pro Auto LLC</p>
        </div>
