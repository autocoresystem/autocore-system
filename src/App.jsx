  ...
  const plans = [
    {
      ...
      price: 'Desde $99/mes',
      features: ['POS básico', 'Facturación', 'Clientes', 'Reportes esenciales', 'Soporte inicial'],
      highlight: false,
    },
    {
      name: 'Pro',
      ...
      price: 'Desde $199/mes',
      features: ['Todo lo de Starter', 'Inventario', 'Cuentas por cobrar', 'Dashboard avanzado', 'Módulos adicionales'],
      highlight: true,
    },
    {
      name: 'Enterprise',
      ...
      features: ['Sistema a la medida', 'Automatizaciones', 'Usuarios múltiples', 'Documentos personalizados', 'Soporte prioritario'],
      highlight: false,
    },
  ];

  const premiumPoints = [
    { title: 'Diseño premium', desc: 'Una experiencia visual moderna que transmite nivel y profesionalismo.', icon: Gem },
    { title: 'Rendimiento ágil', desc: 'Interfaz rápida para trabajar sin fricción en el día a día.', icon: Cpu },
    { title: 'Acceso remoto', desc: 'Opera desde oficina, dealer, taller o celular sin perder control.', icon: Globe },
    { title: 'Trabajo en equipo', desc: 'Ideal para equipos que necesitan orden, visibilidad y seguimiento.', icon: Users },
  ];
    ...
    <div className="min-h-screen bg-black text-white [font-family:Inter,ui-sans-serif,system-ui,sans-serif]">
            ...
            <motion.div {...fadeUp}>
              ...
              <div className="mt-10 grid gap-4 sm:grid-cols-3">
                {[
                  ...
                  return (
                    <div key={item.title} className="rounded-[1.5rem] border border-white/10 bg-white/5 p-4 shadow-2xl shadow-black/20 backdrop-blur-xl">
                ...
                <div className="relative rounded-[1.7rem] border border-white/10 bg-zinc-950 p-5">
                  <div className="mb-5 flex items-center justify-between">
                    <div>
                      ...
                      <h3 className="text-2xl font-black tracking-tight">Control total del negocio en tiempo real</h3>
                    </div>
                  ...
                  <div className="grid gap-4 sm:grid-cols-2">
                    {demoMetrics.map((metric) => (
                      <div key={metric.label} className="rounded-2xl border border-white/10 bg-gradient-to-br from-zinc-900 to-black p-4">
                  ...
                  <div className="mt-4 rounded-2xl border border-white/10 bg-black p-5">
                    <div className="mb-4 flex items-center justify-between">
                      ...
                      <span className="text-xs uppercase tracking-[0.2em] text-red-300">Premium stack</span>
                    </div>
                    <div className="flex flex-wrap gap-2">
                      {modules.map((tag) => (
                        <span key={tag} className="rounded-full border border-white/10 bg-white/5 px-3 py-1 text-sm text-zinc-200">
                          {tag}
                        </span>
                      ))}
                    </div>
      ...
      <section className="mx-auto max-w-7xl px-6 py-16 lg:px-8">
        <motion.div {...fadeUp} className="grid gap-6 md:grid-cols-2 xl:grid-cols-4">
          {premiumPoints.map((item) => {
            const Icon = item.icon;
            return (
              <div key={item.title} className="rounded-[1.75rem] border border-white/10 bg-white/5 p-6 shadow-2xl shadow-black/20 backdrop-blur-xl">
      ...
      <section id="servicios" className="mx-auto max-w-7xl px-6 py-20 lg:px-8">
        <motion.div {...fadeUp} className="max-w-3xl">
          <p className="text-sm font-semibold uppercase tracking-[0.26em] text-red-300">Servicios</p>
          <h2 className="mt-3 text-3xl font-black tracking-tight sm:text-5xl">Una presencia premium respaldada por una plataforma poderosa</h2>
      ...
      <section className="border-y border-white/10 bg-white/[0.03]">
        <div className="mx-auto grid max-w-7xl gap-12 px-6 py-20 lg:grid-cols-2 lg:px-8">
          <motion.div {...fadeUp}>
            <p className="text-sm font-semibold uppercase tracking-[0.25em] text-red-300">Sectores ideales</p>
            <h2 className="mt-3 text-3xl font-black tracking-tight sm:text-5xl">Diseñado para negocios que necesitan control y presencia</h2>
            <div className="mt-8 grid grid-cols-2 gap-4">
              {industries.map((item) => {
                const Icon = item.icon;
                return (
                  <div key={item.name} className="rounded-2xl border border-white/10 bg-zinc-950/80 p-4 text-zinc-200 shadow-xl shadow-black/20">
                    <Icon className="mb-3 h-5 w-5 text-red-500" />
          ...
          <motion.div {...fadeUp}>
            <p className="text-sm font-semibold uppercase tracking-[0.25em] text-zinc-300">Ventajas</p>
            <h2 className="mt-3 text-3xl font-black tracking-tight sm:text-5xl">Por qué AutoCore se siente como una marca premium</h2>
            <div className="mt-8 space-y-4">
              {[
                ...
                <div key={benefit} className="flex items-start gap-3 rounded-2xl border border-white/10 bg-zinc-950/80 p-4 shadow-xl shadow-black/20">
      ...
      <section id="modulos" className="mx-auto max-w-7xl px-6 py-20 lg:px-8">
        <div className="grid gap-12 lg:grid-cols-[0.9fr_1.1fr] lg:items-start">
          <motion.div {...fadeUp}>
            <p className="text-sm font-semibold uppercase tracking-[0.25em] text-red-300">Módulos del sistema</p>
            <h2 className="mt-3 text-3xl font-black tracking-tight sm:text-5xl">Una arquitectura flexible para vender mejor tu solución</h2>
            <p className="mt-4 text-lg leading-8 text-zinc-300">
          ...
          <motion.div {...fadeUp} className="grid grid-cols-2 gap-4">
            {modules.map((module) => (
              <div key={module} className="rounded-[1.5rem] border border-white/10 bg-white/5 p-5 shadow-2xl shadow-black/20">
      ...
      <section id="planes" className="border-y border-white/10 bg-gradient-to-b from-black to-zinc-950">
        <div className="mx-auto max-w-7xl px-6 py-20 lg:px-8">
          <motion.div {...fadeUp} className="mx-auto max-w-3xl text-center">
            <p className="text-sm font-semibold uppercase tracking-[0.25em] text-red-300">Planes</p>
            <h2 className="mt-3 text-3xl font-black tracking-tight sm:text-5xl">Una estructura comercial lista para vender</h2>
            <p className="mt-4 text-lg leading-8 text-zinc-300">
              ...
              >
                ...
                <a
                  ...
                  className={`mt-8 inline-flex w-full items-center justify-center rounded-2xl px-5 py-3 font-semibold transition ${
                    plan.highlight ? 'bg-red-600 text-white hover:scale-[1.02]' : 'border border-white/10 bg-white/5 text-white hover:bg-white/10'
                  }`}
                >
      ...
      <section id="demo" className="mx-auto max-w-7xl px-6 py-20 lg:px-8">
        <div className="grid gap-10 lg:grid-cols-[0.95fr_1.05fr] lg:items-center">
          <motion.div {...fadeUp}>
            <p className="text-sm font-semibold uppercase tracking-[0.25em] text-red-300">Demo del sistema</p>
            <h2 className="mt-3 text-3xl font-black tracking-tight sm:text-5xl">Una vitrina visual que ayuda a cerrar ventas</h2>
            <p className="mt-4 text-lg leading-8 text-zinc-300">
            ...
            <div className="mt-8 space-y-4">
              {[
                ...
                <div key={item} className="flex items-start gap-3 rounded-2xl border border-white/10 bg-white/5 p-4 shadow-xl shadow-black/20">
              ...
              <div className="rounded-[1.7rem] border border-white/10 bg-zinc-950 p-5">
                ...
                <div className="grid gap-4">
                  <div className="grid grid-cols-2 gap-4 md:grid-cols-4">
                    {demoMetrics.map((metric) => (
                      <div key={metric.label} className="rounded-2xl border border-white/10 bg-black p-4">
                  ...
                  <div className="rounded-2xl border border-white/10 bg-black p-5">
                    ...
                    <div className="space-y-3">
                      {['Factura generada', 'Cliente registrado', 'Pago recibido', 'Reporte actualizado'].map((row) => (
                        <div key={row} className="flex items-center justify-between rounded-xl border border-white/5 bg-white/[0.03] px-4 py-3">
      ...
      <section className="mx-auto max-w-7xl px-6 pb-20 lg:px-8">
        <motion.div {...fadeUp} className="rounded-[2.2rem] border border-white/10 bg-gradient-to-br from-red-600/10 via-black to-zinc-500/10 p-8 shadow-[0_40px_120px_rgba(0,0,0,0.35)] lg:p-12">
          <div className="grid gap-10 lg:grid-cols-2 lg:items-center">
            <div>
              <p className="text-sm font-semibold uppercase tracking-[0.25em] text-red-300">Por qué elegir AutoCore</p>
              <h2 className="mt-3 text-3xl font-black tracking-tight sm:text-5xl">No vendes solo un sistema: vendes orden, imagen y crecimiento</h2>
              <p className="mt-4 text-lg leading-8 text-zinc-300">
            ...
            <div className="grid gap-4">
              {[
                ...
                <div key={step} className="rounded-2xl border border-white/10 bg-black/30 p-5 shadow-xl shadow-black/20">
        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <motion.div {...fadeUp} className="grid gap-8 lg:grid-cols-[0.9fr_1.1fr]">
            <div className="rounded-[2.2rem] border border-white/10 bg-white/5 p-8 shadow-[0_35px_120px_rgba(0,0,0,0.35)] backdrop-blur-2xl lg:p-10">
              <p className="text-sm font-semibold uppercase tracking-[0.25em] text-red-300">Contacto</p>
              <h2 className="mt-3 text-3xl font-black tracking-tight sm:text-5xl">Haz que AutoCore se vea como una marca lista para cerrar clientes reales</h2>
              ...
              <div className="mt-8 flex flex-col gap-4 sm:flex-row">
                <a href="mailto:ventas@autocoresystem.com" className="inline-flex items-center justify-center gap-2 rounded-2xl bg-red-600 px-6 py-3.5 font-semibold transition hover:scale-[1.02]">
                  <FileText className="h-4 w-4" />
                  Escribir por email
                </a>
                <a href="https://wa.me/18000000000" className="inline-flex items-center justify-center gap-2 rounded-2xl border border-white/15 bg-white/5 px-6 py-3.5 font-semibold transition hover:bg-white/10">
              ...
              <div className="mt-8 rounded-[1.75rem] border border-red-500/15 bg-gradient-to-br from-red-600/10 to-transparent p-5">
                <p className="text-sm font-semibold uppercase tracking-[0.2em] text-red-300">Tabla sugerida</p>
                <div className="mt-4 grid gap-2 text-sm text-zinc-300 sm:grid-cols-2">
                  {['id', 'nombre', 'negocio', 'telefono', 'email', 'tipo_negocio', 'mensaje', 'created_at'].map((field) => (
                    <div key={field} className="rounded-xl border border-white/10 bg-black/30 px-3 py-2">
                      leads.{field}
                    </div>
                  ))}
                </div>
            ...
            <div className="rounded-[2.2rem] border border-white/10 bg-white/5 p-8 shadow-[0_35px_120px_rgba(0,0,0,0.35)] backdrop-blur-2xl lg:p-10">
              <div className="mb-6 flex items-center justify-between">
                <div>
                  <p className="text-sm font-semibold uppercase tracking-[0.22em] text-red-300">Formulario de contacto</p>
                  <h3 className="mt-2 text-2xl font-black tracking-tight">Solicita información o una cotización</h3>
                </div>
              ...
              <form className="space-y-5">
                <div className="grid gap-5 md:grid-cols-2">
                  ...
                  <div>
                    <label className="mb-2 block text-sm font-medium text-zinc-300">Negocio</label>
                    <input
                      type="text"
                ...
                <div>
                  <label className="mb-2 block text-sm font-medium text-zinc-300">Tipo de negocio</label>
                ...
                <div>
                  <label className="mb-2 block text-sm font-medium text-zinc-300">Mensaje</label>
                  <textarea
                    rows={6}
                ...
                <p className="text-sm leading-7 text-zinc-400">
                  Esta versión ya deja el formulario listo visualmente. El siguiente paso sería conectarlo a Supabase o a tu backend en Render para guardar los leads en la tabla <span className="font-semibold text-zinc-300">leads</span>.
                </p>
              </form>
            </div>
          </motion.div>
